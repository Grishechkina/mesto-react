...
function App() {
  ...
  return (
    <div className="page">
      ...
      <Footer />
      <PopupWithForm popupHeader="Редактировать профиль" popupName="edit-pop-up"
      ...
      <PopupWithForm popupHeader="Обновить аватар" popupName="edit-avatar-pop-up" 
      ...
      <PopupWithForm popupHeader="Новое место" popupName="add-card-pop-up"
